...
REPOSITORY_DIR=~/web-workspace/jwp-woowahan/cherry-jwp-spring-boot
...
BRANCHES=("step5-orm" "step6-refactoring-entity" "step7-restful-api" "step8-rest-assured" "step9-oop-delete-question")
COMMIT_REVISION=7ce43c1
